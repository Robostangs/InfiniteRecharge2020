...
public class IntakeTester {
    ...
    public static void itTester(TalonSRX belt, TalonSRX ingestor)
    {
        ...
        for(int motornum=0; motornum<motors.size();motornum++){
            TalonSRX motor=motors.get(motornum);
            ...
            {   
                ...
                System.out.println("TalonSRX: " + motor.getDeviceID() + " is currently outputting at " + motor.getStatorCurrent() + " Amps!");
            ...
            {   
                ...
                System.out.println("TalonSRX: " + motor.getDeviceID() + " is currently outputting at " + motor.getSelectedSensorVelocity()*(50.0/15) + " RPM!");
