public class DriveStraight extends AutoCommandBase{
    private double power, distance, threshold, elevatorSetPoint, ingestorPower;
	
	public DriveStraight(double timeOut, double power, double distance, double elevatorSetPoint, double ingestorPower){
		super(timeOut);
		this.power = power;
